...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class DiagnosticsPass
    {
        ...
        private bool IsDefined(ref bool? field, WellKnownType type)
        {
            ...
            if (!field.HasValue)
            {
                field = _compilation.GetTypeByMetadataName(type.GetMetadataName()) is not null;
            }
        ...
        public override BoundNode VisitArrayCreation(BoundArrayCreation node)
        {
            ...
            if (_inExpressionLambda && !HasCSharpExpression && node.InitializerOpt != null && !arrayType.IsSZArray)
            {
